...
The `mosaic` package attempts to facilitate a Less Volume, More Creativity
approach.
...
```{r, eval = FALSE}
     xyplot(age ~ substance, data = HELPrct, jitter.x = TRUE)
 ...
 * [https://cdn.rawgit.com/ProjectMOSAIC/mosaic/master/vignettes/mosaic-resources.Rmd](Resources Vignette)
    * Available in package and via github
    * Links to companion volumes for several texts (Lock5, ISI, Statistical Slueth, IPS)

## Elsewhere at eCOTS

Mon @ 1:00 - 1:30	*Changing with technology to facilitate learning: Ideas for using technology to find new ways to help students to achieve learning outcomes*
